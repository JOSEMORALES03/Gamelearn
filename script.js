...
function cargarPreguntaMatchingPairs() {
    ...
    document.getElementById('btn-volver-temas').addEventListener('click', () => {
        if (cronometroIntervalo) clearInterval(cronometroIntervalo);
        mostrarTemas(materiaActual, 'matchingPairs');
    });
    document.getElementById('btn-siguiente-pregunta').addEventListener('click', async () => {
        contenedorJuegoEl.classList.add('anim-out');
        setTimeout(() => {
...
function cargarPreguntaFindTheError() {
    ...
    document.getElementById('btn-volver-temas').addEventListener('click', () => {
        if (cronometroIntervalo) clearInterval(cronometroIntervalo);
        mostrarTemas(materiaActual, 'findTheError');
    });
    document.getElementById('btn-siguiente-pregunta').addEventListener('click', async () => {
        contenedorJuegoEl.classList.add('anim-out');
        setTimeout(() => {
...
function cargarPreguntaQuiz() {
    ...
    document.getElementById('btn-volver-temas').addEventListener('click', () => {
        if (cronometroIntervalo) clearInterval(cronometroIntervalo);
        mostrarTemas(materiaActual, 'quiz');
    });
    document.getElementById('btn-siguiente-pregunta').addEventListener('click', async () => {
        contenedorJuegoEl.classList.add('anim-out');
        setTimeout(() => {
...
function cargarPreguntaBasicOperations() {
    ...
    document.getElementById('btn-volver-temas').addEventListener('click', () => {
        if (cronometroIntervalo) clearInterval(cronometroIntervalo);
        mostrarTemas(materiaActual, 'basicOperations');
    });
    document.getElementById('btn-siguiente-pregunta').addEventListener('click', async () => {
        contenedorJuegoEl.classList.add('anim-out');
        setTimeout(() => {
...
function cargarPreguntaEquationSolver() {
    ...
    document.getElementById('btn-volver-temas').addEventListener('click', () => {
        if (cronometroIntervalo) clearInterval(cronometroIntervalo);
        mostrarTemas(materiaActual, 'equationSolver');
    });
    document.getElementById('btn-siguiente-pregunta').addEventListener('click', async () => {
        contenedorJuegoEl.classList.add('anim-out');
        setTimeout(() => {
...
function cargarPreguntaNumberSequence() {
    ...
    document.getElementById('btn-volver-temas').addEventListener('click', () => {
        if (cronometroIntervalo) clearInterval(cronometroIntervalo);
        mostrarTemas(materiaActual, 'numberSequence');
    });
    document.getElementById('btn-siguiente-pregunta').addEventListener('click', async () => {
        contenedorJuegoEl.classList.add('anim-out');
        setTimeout(() => {
...
function cargarPreguntaDragAndDropMatch() {
    ...
    function checkClickMatch() {
        ...
        }, 400); // Un poco menos que la animación de error para evitar solapamientos
    }

    document.getElementById('btn-volver-temas').addEventListener('click', () => {
        if (cronometroIntervalo) clearInterval(cronometroIntervalo);
        mostrarTemas(materiaActual, 'dragAndDropMatch');
    });
...
function cargarPreguntaNumberOrder() {
    ...
    document.getElementById('btn-volver-temas').addEventListener('click', () => {
        if (cronometroIntervalo) clearInterval(cronometroIntervalo);
        mostrarTemas(materiaActual, 'numberOrder');
    });
    document.getElementById('btn-siguiente-pregunta').addEventListener('click', () => {
        contenedorJuegoEl.classList.add('anim-out');
        setTimeout(() => {
...
function mostrarResultados() {
    ...
    if (tipoJuego === 'matchingPairs' || tipoJuego === 'dragAndDropMatch') {
...
function mostrarFormularioCreacion(tipoJuego, claveTemaParaEditar = null) {
    ...
    const tituloFormulario = document.querySelector('.tarjeta-creacion h2');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Deshabilitar botones de rol inicialmente
    ...
    document.getElementById('btn-volver-rol').addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            seleccionRolEl.style.display = 'flex'; // Muestra la selección de rol
            seleccionRolEl.classList.add('anim-in'); // Anima la entrada de la selección de rol
            aceptacionTerminosRolEl.style.display = 'block'; // Muestra los términos de nuevo
    ...
    btnCambiarGrado.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            loginDocenteEl.style.display = 'none'; // Oculta login
    ...
    btnCambiarRol.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            document.getElementById('password-input').value = '';
            checkboxTerminosRol.checked = false; // Desmarca los términos
            btnRolEstudiante.disabled = true; // Deshabilita los botones de rol
            btnRolDocente.disabled = true;
        }, animDuration);
    });
